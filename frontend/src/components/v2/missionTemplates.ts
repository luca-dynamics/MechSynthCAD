...
export const v2MissionTemplates: V2MissionTemplate[] = [
  ...
  },
  {
    ...
    description: "Open the Report Draft artifact, highlight Supervisor Submission Mode, and prepare a supervisor-ready academic deliverable from deterministic evidence.",
    suggestedCommand: "Prepare a supervisor-ready academic report from the current deterministic mechanism evidence.",
    targetArtifact: "report",
    missionSection: "report",
    expectedSteps: ["Open Report Draft artifact", "Review Supervisor Submission Mode", "Complete academic metadata", "Validate source-of-truth notes"],
  },
  {
